# Clojure NLP web service

Web service for natural language processing written in Clojure
...
get the app created:
    ...
    $ heroku apps:create cljnlp
    Creating cljnlp... done, stack is cedar
    http://cljnlp.herokuapp.com/ | git@heroku.com:cljnlp.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://cljnlp.herokuapp.com deployed to Heroku

    To git@heroku.com:cljnlp.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://cljnlp.herokuap.com
    ["Hello" :from Heroku]
...
Copyright © 2013 Nikolay Stoitsev
