...
main.handle_response = function handle_response(data) {
  if(cljs.core._EQ_.call(null, data, "")) {
    ...
    var ping__13289 = clojure.string.replace.call(null, data["ping"], "\n", "<br/>");
    var whois__13290 = clojure.string.replace.call(null, data["whois"], "\n", "<br/>");
    var nmap__13291 = clojure.string.replace.call(null, data["nmap"], "\n", "<br/>");
    var traceroute__13292 = clojure.string.replace.call(null, data["traceroute"], "\n", "<br/>");
    jQuery("#ping").html(ping__13289);
    jQuery("#whois").html(whois__13290);
    jQuery("#nmap").html(nmap__13291);
    return jQuery("#traceroute").html(traceroute__13292)
  }
};
main.submit_handler = function submit_handler() {
  var input_field__13296 = jQuery("#inputURL");
  var error__13297 = jQuery("#error");
  error__13297.text("");
  var value__13298 = encodeURIComponent(input_field__13296.val());
  if(cljs.core._EQ_.call(null, value__13298, "")) {
    error__13297.text("Please enter valid URL!")
  }else {
    jQuery("#loading").show();
    jQuery.get([cljs.core.str("/input/"), cljs.core.str(value__13298)].join(""), main.handle_response)
  }
  return false
};
var submit_button__13299 = jQuery("#submit");
submit_button__13299.on("click", main.submit_handler);
